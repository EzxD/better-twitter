...
const Overlay = ({ children }) => {
  ...
  if (loading || !session || !session.user) {
    return (
      <div>
        <header className="flex  items-center px-[15px] py-3 border-b animate-pulse">
          <div className="h-[30px] w-[30px] rounded-full bg-gray-300 " />
          <div className="pl-4 flex-grow">
            <div className=" w-1/2 bg-gray-300 h-6 " />
          </div>
        </header>
      </div>
    );
      ...
      <div className="flex flex-col items-center justify-center w-screen h-screen mx-auto text-base text-gray-900 bg-cool-gray-200 xs:py-8">
        ...
        >
          <header className="flex items-center px-4 py-3 border-b">
            ...
            <p className="ml-6 text-md font-extrabold">Neueste Tweets</p>
          </header>
